...
# v5c: tiny iteration over v5a
# - keep v5a behavior
# - reduce clip when inventory is stretched to improve portal stability
LIMIT = 10
MM_CLIP = 4
INV_SKEW = 0.30
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for sym in state.order_depths.keys():
            ...
            clip = MM_CLIP
            if abs(pos) >= INV_STRETCH_THRESHOLD:
                clip = max(2, MM_CLIP - 1)
