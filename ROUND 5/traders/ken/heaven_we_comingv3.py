...
class Trader:
    """
    heaven_we_comingv3:
    - Core from peter/answer.py: passive market making + inventory skew.
    - Safety overlay from our v1/v2 lessons:
      * trade only high-quality symbols
      * strict spread caps
      * per-symbol hard limit 10
      * reduced clip sizes
    """
    ...
    # Conservative tradable set (exclude known heavy drags from v1/v2).
    ...
    def run(self, state: TradingState):
        ...
        # Leader-lag skew (small and only on lag symbol).
        ...
        for sym in sorted(self.SYMBOLS.keys()):
            ...
            # Quote inside if possible, else at touch.
            if spread >= 2:
