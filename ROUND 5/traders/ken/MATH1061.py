...
class Trader:
    """
    MATH1061 (live-safe profile):
    - Conservative shock reversion on selected symbols.
    - Includes session gate to avoid late-regime drawdown behavior.
    """
    ...
    def run(self, state: TradingState):
        ...
        # Skip late session regime (this is what made live safer for 1052).
        if mem["day_idx"] >= 2:
