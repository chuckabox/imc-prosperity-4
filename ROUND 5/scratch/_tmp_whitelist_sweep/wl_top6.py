...
class Trader:
    SYMBOLS = {'PANEL_2X4', 'SNACKPACK_PISTACHIO', 'OXYGEN_SHAKE_EVENING_BREATH', 'SNACKPACK_STRAWBERRY', 'SLEEP_POD_NYLON', 'UV_VISOR_AMBER'}
    LIMITS = {'PANEL_2X4': 14, 'SLEEP_POD_NYLON': 14, 'SNACKPACK_PISTACHIO': 14, 'UV_VISOR_AMBER': 14, 'SNACKPACK_STRAWBERRY': 14, 'OXYGEN_SHAKE_EVENING_BREATH': 14}
    MM_EDGE = 2
    MM_CLIP = 2
    INV_SKEW = 0.10
    SHOCK_TRIGGER = 14.0
