...
class Trader:
    SYMBOLS = {'GALAXY_SOUNDS_DARK_MATTER', 'PANEL_2X4', 'SNACKPACK_PISTACHIO', 'OXYGEN_SHAKE_EVENING_BREATH', 'PEBBLES_XS', 'MICROCHIP_SQUARE', 'ROBOT_IRONING', 'TRANSLATOR_VOID_BLUE', 'SLEEP_POD_NYLON', 'UV_VISOR_AMBER'}
    LIMITS = {'PANEL_2X4': 14, 'SLEEP_POD_NYLON': 14, 'SNACKPACK_PISTACHIO': 14, 'UV_VISOR_AMBER': 14, 'OXYGEN_SHAKE_EVENING_BREATH': 14, 'MICROCHIP_SQUARE': 14, 'ROBOT_IRONING': 14, 'PEBBLES_XS': 14, 'GALAXY_SOUNDS_DARK_MATTER': 14, 'TRANSLATOR_VOID_BLUE': 14}
    MM_EDGE = 2
    MM_CLIP = 2
    INV_SKEW = 0.10
    SHOCK_TRIGGER = 14.0
