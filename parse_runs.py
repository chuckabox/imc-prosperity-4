...
runs_dir = r'external\prosperity_rust_backtester\runs'
backtest_data = {}

log_folders = glob.glob(os.path.join(runs_dir, '*'))
...
for folder in log_folders:
    ...
    # Extract round number from dataset_id like "prices_round_3_day_0"
    round_num = 3
...
with open('backtest_comparison.js', 'w') as f:
