...
Rainforest Resin was by far the easiest product to trade, and probably one of the most consistently profitable across the entire competition. The sample data revealed that the fair value hovered exactly around 10,000 seashells, with almost no drift and extremely low volatility (typically deviating by no more than ±4 seashells). Market taking was straightforward: any time there was a bid above 10,000 or an ask below 10,000, we would immediately execute against it. On top of that, the order book had relatively wide spreads, which opened up market making opportunities by posting liquidity just inside the standing bids and asks. This product was a basic but crucial test of a participant’s ability to spot clean EV trades and to squeeze extra edge via tight, passive orders.

Kelp was a little more complicated. It displayed some mild price drift and a small but noticeable amount of volatility, making it dangerous to blindly market take at a fixed value. Instead, we adapted by market making dynamically around the mid price, continuously adjusting to its slow trend. The spreads were even wider than Resin, which made market making particularly attractive if you stayed disciplined and size-adjusted correctly. This product seemed like a deliberate test of basic market making skills, including how well participants could manage position exposure in the face of low but persistent trends.

Then came Squid Ink — easily the most infamous product of the entire event. Squid Ink was extremely volatile, with 10–20% swings intraday and seemingly no clear pattern. The IMC parrot kept hinting that “there’s a pattern if you look closely,” but to be honest, we don't believe any real exploitable structure existed. We tested a variety of strategies, including rolling z-scores, volatility breakouts, and MACD signals, but none offered any consistent edge. Pure market making also failed: the bid-ask spread was razor thin, meaning we weren't compensated enough for the massive inventory risks. Worse, naive market making often led us to max out our position limits against fast-moving trends, resulting in huge drawdowns.

After a lot of iteration, we landed on a hybrid strategy. We used long-short EMA signals to **bias our market making directionally**, favoring aggressive bids during bullish momentum and aggressive offers during bearish moves. This allowed us to lean into the prevailing trend while still capturing spread. Additionally, we allowed ourselves to exit positions at breakeven when necessary, prioritizing liquidity over theoretical gains. This adjustment helped us survive the massive whipsaws without getting permanently trapped against the move. 
