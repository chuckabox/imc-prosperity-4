"""trader_ken_v58_meta_policy.py

Meta-policy over two internal policies:
- Policy A (alpha): v41-like aggressive capture.
- Policy B (defense): tighter taker and wider maker for costly states.

Switch signal uses live-cost proxies (spread, jump, inventory pressure).
"""
