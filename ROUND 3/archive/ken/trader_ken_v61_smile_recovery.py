"""trader_ken_v61_smile_recovery.py

v60 + recovery-factor controls:
- Tracks a lightweight equity proxy from mark-to-market deltas.
- Applies drawdown-aware risk scaling and temporary taker clamp in deep drawdown.
- Keeps volatility-smile residual options alpha.
"""
...
class Trader:
    ...
    def _update_equity_proxy(self, state: TradingState):
        mids: Dict[str, float] = {}
        for sym in [HYDRO, VFE, "VEV_5000", "VEV_5100"]:
