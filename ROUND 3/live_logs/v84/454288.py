"""trader_ken_v84_pair_rv.py

Standalone v84:
- Keeps proven HYDROGEL + VFE execution stack
- Replaces directional-heavy VEV logic with cross-strike relative-value pairs
  (buy cheap low strikes, sell rich higher strikes)
- Adds inventory decay after the early session to protect accumulated PnL
"""
