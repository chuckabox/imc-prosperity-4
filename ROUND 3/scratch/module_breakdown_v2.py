"""module_breakdown_v2.py — PnL attribution with hedging enabled."""
...
def _load_trader_module():
    ...
    spec = importlib.util.spec_from_file_location("user_trader1_bd2", TRADER_PATH)
...
def main():
    ...
    configs = [
        ("ALL+HEDGE",    dict(ENABLE_HYDROGEL=True,  ENABLE_VFE=True,  ENABLE_VEV=True,  ENABLE_HEDGE=True)),
        ("ALL-NOHEDGE",  dict(ENABLE_HYDROGEL=True,  ENABLE_VFE=True,  ENABLE_VEV=True,  ENABLE_HEDGE=False)),
        ("HP_ONLY",      dict(ENABLE_HYDROGEL=True,  ENABLE_VFE=False, ENABLE_VEV=False, ENABLE_HEDGE=False)),
        ("VEV+HEDGE",    dict(ENABLE_HYDROGEL=False, ENABLE_VFE=False, ENABLE_VEV=True,  ENABLE_HEDGE=True)),
        ("VEV_NOHEDGE",  dict(ENABLE_HYDROGEL=False, ENABLE_VFE=False, ENABLE_VEV=True,  ENABLE_HEDGE=False)),
        ("VFE_ONLY",     dict(ENABLE_HYDROGEL=False, ENABLE_VFE=True,  ENABLE_VEV=False, ENABLE_HEDGE=False)),
    ]
