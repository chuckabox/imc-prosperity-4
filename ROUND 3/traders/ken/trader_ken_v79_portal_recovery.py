...
class Trader:
    ...
    def _hydrogel_logic(self, state: TradingState, scale: float, risk_off: bool) -> Tuple[List[Order], Optional[float]]:
        ...
        taker_max = max(12, int(self.HP_TAKER_MAX * local_scale))
        maker_max = max(34, int(126 * local_scale))
    ...
    def _vfe_logic(
        ...
        taker_max = max(8, int(self.VFE_TAKER_MAX * local_scale))
        maker_max = max(24, int(112 * local_scale))
