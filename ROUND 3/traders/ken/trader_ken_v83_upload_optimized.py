"""trader_ken_v83_upload_optimized.py

Standalone v83 (no imports from older trader files).

Design intent:
- Keep v81 hybrid core that has strongest observed live-slice behavior.
- Add day-2 upload alignment and strict VEV_5200 risk controls.
- Use a two-phase options risk profile:
  - phase 1 (early): capture opening edge
  - phase 2 (later): tighten inventory and entry edge to protect PnL
"""
...
class Trader:
    ...
    VEV_TAKE_EDGE_DEFAULT = 1.0
    VEV_TAKE_EDGE_5200 = 2.0
    VEV_CAP = 60
    VEV_5200_CAP = 40
    VEV_GLOBAL_ABS_CAP = 320
    VEV_PHASE_SWITCH_TS = 150_000
    VEV_PHASE2_CAP_SCALE = 0.60
    VEV_PHASE2_EDGE_BUMP = 0.6
