"""trader_ken_v56_dual_allocator.py
...
- Allocator: stricter option gating + lower activity to protect day2.
"""
...
class Trader:
    ...
    def _allocator(self, state: TradingState, vfe_mid: Optional[float]) -> Tuple[float, float]:
        ...
        # Budget split
        hydro_scale = risk_scale * (0.90 if opt_on else 1.00)
        opt_scale = risk_scale * (0.75 if opt_on else 0.20)
        return hydro_scale, opt_scale
