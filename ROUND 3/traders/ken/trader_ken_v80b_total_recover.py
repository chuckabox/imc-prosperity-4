"""trader_ken_v80b_total_recover.py

Standalone v80b: total-PnL recovery variant from v80.
- Keeps v80's product-PnL quality controls.
- Slightly loosens VEV entry and increases selective throughput.
- Keeps hedge churn controlled but less restrictive than v80.
"""
...
class Trader:
    ...
    # VFE aggressive, slightly freer than v80
    VFE_LIMIT = 200
    VFE_EWMA_ALPHA = 0.22
    VFE_MAKER_EDGE = 1.05
    VFE_TAKER_EDGE = 1.9
    ...
    VFE_MICRO_TILT = 0.23
    VFE_HEDGE_BAND = 16
    VFE_HEDGE_AGGRO_BAND = 64
    VFE_HEDGE_MAX = 36

    # VEV: modestly looser than v80 for more total capture
    PREM_ALPHA = 0.06
    PREM_VAR_ALPHA = 0.08
    VEV_Z_ENTRY = 0.86
    VEV_REL_Z_ENTRY = 0.68
    VEV_REL_Z_BOOST = 1.40
    VEV_STRONG_PAIR_SIZE_MULT = 1.66
    VEV_SPREAD_MAX_BY_STRIKE: Dict[int, int] = {5000: 5, 5100: 5, 5200: 4, 5300: 4, 5400: 5}
    VEV_STRONG_SPREAD_MAX = 2
    VEV_TAKER_MAX_BY_STRIKE: Dict[int, int] = {5000: 9, 5100: 11, 5200: 15, 5300: 15, 5400: 9}
    VEV_MAKER_MAX_BY_STRIKE: Dict[int, int] = {5000: 6, 5100: 8, 5200: 11, 5300: 11, 5400: 6}
    VEV_MAKER_EDGE = 1.0
    VEV_STRUCT_LONG_Z = -0.44
    VEV_STRUCT_LONG_SIZE = 6
    VEV_STRUCT_LONG_SPREAD_MAX = 2

    # Risk: slightly looser than v80
    RISK_NET_DELTA_TRIGGER = 126.0
    RISK_HP_POS_TRIGGER = 182
    RISK_ADVERSE_MOVE = 2.6
    RISK_MIN_SCALE = 0.23
    RISK_VEV_GUARD_TS = 0
    RISK_VEV_GUARD_DECAY = 0.978
    RISK_VEV_GUARD_SCALE_CUT = 0.17
    RISK_VEV_GUARD_Z_BUMP = 0.07
    RISK_VEV_GUARD_REL_BUMP = 0.07

    # soft brakes
    OPEN_PHASE_TS = 120_000
    HP_SPEED_TRIGGER = 62
    VFE_SPEED_TRIGGER = 56
    SPEED_COOLDOWN_TS = 40_000
    OPEN_SCALE_MULT = 0.97
    SPEED_SCALE_MULT = 0.91
    ...
    def _hydrogel_logic(self, state: TradingState, scale: float, risk_off: bool) -> Tuple[List[Order], Optional[float]]:
        ...
        maker_max = max(44, int(152 * local_scale))
        if not risk_off:
    ...
    def _vfe_logic(self, state: TradingState, scale: float, risk_off: bool, target_pos: Optional[int] = None) -> Tuple[List[Order], Optional[float]]:
        ...
        maker_max = max(29, int(124 * local_scale))
