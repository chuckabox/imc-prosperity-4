        ...
        if hydro_mid is not None:
            ...
            result["HYDROGEL_PACK"].extend(
                self._mm_orders(
                    ...
                    state,
                    hydro_mid,
                    self.CFG.get("hydro_edge", 6),
                    self.CFG.get("hydro_clip", 8),
                    skew,
                )
            )
            result["HYDROGEL_PACK"].extend(
                self._take_edge_orders(
                    ...
                    state,
                    hydro_mid + skew,
                    self.CFG.get("hydro_take_th", 2.0),
                    self.CFG.get("hydro_take_size", 6),
                )
            )
        ...
        if vfe_mid is not None:
            ...
            result["VELVETFRUIT_EXTRACT"].extend(
                self._mm_orders(
                    ...
                    state,
                    vfe_mid,
                    self.CFG.get("vfe_edge", 2),
                    self.CFG.get("vfe_clip", 8),
                    skew,
                )
            )
            result["VELVETFRUIT_EXTRACT"].extend(
                self._take_edge_orders(
                    ...
                    state,
                    vfe_mid + skew,
                    self.CFG.get("vfe_take_th", 1.4),
                    self.CFG.get("vfe_take_size", 6),
                )
            )
