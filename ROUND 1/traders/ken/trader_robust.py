...
class Trader:
    """
    Robust Adaptive Trader v3 - Passive-First
    -------------------------------------------
    Philosophy: Income comes from passive market-making fills.
    Aggressive takes are ONLY for extreme mispricings.
    Position management prevents blow-ups in any regime.

    Pepper Root: Trend-skewed passive MM. No chasing.
    Osmium: Tight mean-reversion MM around adaptive anchor.
    """
