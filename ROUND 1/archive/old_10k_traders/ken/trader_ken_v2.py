...
class Trader:
    """
    trader_ken v2
    Baseline reset to proven 10k-style logic:
    - Osmium anchored fair + sniper + aggressive pennying
    - Pepper AR(3) fair + momentum confluence + trend-following accumulation
    """
