<!--
Dump everything here. Messy is fine — overview, results, how each round went,
which traders you ended up using, scores/PnL, what worked, what didn't.
When done, tell me and I'll turn it into the project README.md.
-->
...
Round 1 | intara
Trading groundwork
You have reached Intara and are setting up a Trade Outpost to act as your trading hub on this planet. Your goal: earn at least a net 200,000 XIRECs by the end of Round 2.Algorithmic Challenge
First Intarian goods
Inactive
...
Recent upload
Brief
Start building your Python program with the first two available tradable goods: Ash-coated Osmium and Intarian Pepper Root. Use the historical data from the Data Capsule to develop a profitable strategy, translate it to a Python program and upload it to the network.
...
Download the data file to analyze the performance history of Ash-Coated Osmium and Intarian Pepper Root.

TG01
Ash-coated Osmium
Ash-coated Osmium
TG02
Intarian Pepper Rootpload & Changelog
When you’re ready, upload your Python program here. There is no limit to the number of programs you can upload.

Drop your file here
You are only allowed to upload .py files with a maximum size of 100 KB.


Select file

128-trader_robust_peter_v12.py

Active algorithm uploaded by Peter Ma
...
Crew Honors
15 Badges unlocked
See which badges your team unlocked and how.
...
RESULTS DRYLAND FLAX TRADE ORDER
Your team's PnL
9,999
PnL per bid volume
PNL VS VOLUME AT BID PRICE: + 30BID VOLUMEPNL AFTER FEES
0
2,500
5,000
7,500
...
RESULTS EMBER MUSHROOM TRADE ORDER
Your team's PnL
77,996.10
PnL per bid volume
PNL VS VOLUME AT BID PRICE: + 20BID VOLUMEPNL AFTER FEES
0
20,000
40,000
60,000
...
60,000
90,000
Explore essential knowledge
Prosperity Wiki
Connect with the community
Prosperity Discord
Round 1 | intara
Trading groundwork
You have reached Intara and are setting up a Trade Outpost to act as your trading hub on this planet. Your goal: earn at least a net 200,000 XIRECs by the end of Round 2.
...
This order book shows a stale state of bids and asks for Dryland Flax. Use this to determine your own strategy and order input. Any Dryland Flax you acquire will be sold directly after the auction closes for 30 XIRECs per piece.
...
This order book shows a stale state of bids and asks for Ember Mushroom. Use this to determine your own strategy and order input. Trading fees per volume apply: 0.05 XIRECs for buying and 0.05 XIRECs for selling. Any Ember Mushroom you acquire will be sold directly after the auction closes for 20 XIRECs per piece.
...
Dryland Flax Trade Order
Select order type from the dropdown, enter your volume and price. Don't forget to submit your order.
...
30
Price*
Insert your preferred price (e.g. 28)
9999
Volume*
Insert your preferred volume (e.g. 12000)

Ember Mushroom Trade Order
Select order type from the dropdown, enter your volume and price. Don't forget to submit your order.
...
Clear all
Last updated 52 days ago by Adin Sreekesh.
...
algo results round 1 ![alt text](image-1.png)

manual results round 1 dryland ![alt text](image-3.png)

manual results round 1 ember mushroom ![alt text](image-4.png)
...
Intarian Pepper Root
Download data capsule
A.R.I.A. Uplink
Review the A.R.I.A. Uplink from the current round

This A.R.I.A. Uplink contains all the basic information needed to start working on your strategy and Python program.
...
Clear all
Last updated 50 days ago by Peter Ma.
...
Your Team's Speed Investment

0

Other Team's Speed Investment

Speed InvestmentNumber of Teams
0
10
20
30
...
algo round 2 ![alt text](image-5.png)

manual trading roudn 2 resukts ![alt text](image-6.png)![alt text](image-7.png)
...
Round 3 | Solvenar
Gloves off
Welcome to Solvenar. The Great Orbital Ascension Trials begin now. Profit and Loss indicators and the leaderboard have been reset. It's anyone's game now. Three trading rounds remain to prove you are the trading champion of the galaxy.


View results
Aria Uplink
Algorithmic Challenge
Options require decisions
Inactive
...
Algorithmic Challenge
Brief
You have three new tradable goods available to trade with. Incorporate these Hydrogel Packs, Velvetfruit Extracts, and Velvetfruit Extract Vouchers (VEVs) into your strategy and translate it into a new Python program to upload to the network.
...
Download the data file to analyze the performance history of Hydrogel Packs and Velvetfruit Extract.
...
The Celestial Gardeners' Guild is making a rare appearance on Solvenar during the Great Orbital Ascension Trials!

They’ve brought a limited supply of Ornamental Bio-Pods and are offering a one-time opportunity to trade with participating crews. After this round, the Guild will continue their trade mission to another planet, where they’ll attempt to sell any remaining Bio-Pods. This is a one-time opportunity and does not affect your algorithmic trading activities. Enter your submission below and click Submit to confirm.

YOUR task
Each team may submit two price offers (between 670 and 920 XIRECs) for a chance to trade. The so-called “Guardeners” of the Guild will accept the lowest bid that exceeds their personal reserve price. For the second offer, they’ll also factor in the global average bid submitted by other crews. If your bid is above that average, you’re likely to close the deal. But if it falls below, the probability of a trade decreases sharply. Don’t forget to submit your bids when you are ready.
...
Clear all
Last updated 44 days ago by Adin Sreekesh.
...
algo round 3 ![alt text](image-9.png)

manual round 3 ![alt text](image-8.png) ![alt text](image-10.png)
...
The Frontier Trade Watch disclosed information about the counterparties active on the market. These counterparties also provide new opportunities in the form of some interesting option contracts.
...
Option	Expiry	Size	Bid	Ask	Size	Buy/sell	Volume	Price
N/A	200	49.975	50.025	200	
...
Clear all
Last updated 41 days ago by Adin Sreekesh.
...
round 4 algo: ![alt text](image-11.png)

round 4 manual: ![alt text](image-12.png) ![alt text](image-13.png)
...
Round 05 | Solvenar
The final stretch
In this final round, you will have 50 new tradable goods available to build a final Python program with. You've also been invited to trade on the market of our neighboring planet, Ignith. Inform yourself by reading through their news source “Ashflow Alpha” before making a final move on their heated market.
...
Download the data file to analyze the performance history of all available tradable goods.

TG01
Galaxy Sounds Recordings
Galaxy Sounds Recordings
TG02
Vertical Sleeping Pods
Vertical Sleeping Pods
TG03
Organic Microchip Modules
Organic Microchip Modules
TG04
...
Download Ashflow Alpha
Your orders
Choose which tradable goods you would like to trade on the Ignith market.
...
Clear all
Last updated 39 days ago by Adin Sreekesh.
...
Share your mission milestone
Now that the hard work is over, it is time to show the world what you achieved in Prosperity 4. Celebrate with this personalized Mission Milestone, visualizing your team rank, final PnL, and completion of Prosperity 4.
...
round 5 algo: ![alt text](image-14.png)

round 5 manual: ![alt text](image-15.png)


manuals submitted were by sidd and adin! thats why their names dont pop up much.
